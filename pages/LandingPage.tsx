      ...
      <section className="py-24 bg-gray-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <button onClick={onLogin} className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gray-200 text-gray-900 border border-gray-300 rounded-xl text-lg font-bold hover:bg-gray-300 transition">
