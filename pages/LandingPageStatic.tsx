      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-7xl mx-auto">
          ...
          <div className="bg-gray-50 p-6 rounded-2xl border-2 border-green-600 relative flex flex-col">
            ...
            <CtaLink className="w-full py-3 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 transition text-center block">
              Join the Beta
            </CtaLink>
          </div>
