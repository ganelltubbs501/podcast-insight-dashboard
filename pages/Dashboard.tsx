        ...
        <div className="bg-gray-100 p-6 rounded-xl border border-gray-300 shadow-sm flex items-center justify-between relative overflow-hidden">
          <div className="z-10">
            ...
            <p className="text-3xl font-bold text-textPrimary">
              {metrics?.transcriptsUsed || 0} <span className="text-lg text-textMuted font-normal">/ {metrics?.transcriptQuota || 0}</span>
            </p>
        ...
        {isNearLimit ? (
          ...
          <div className="bg-gray-100 p-6 rounded-xl border border-gray-300 shadow-sm flex flex-col justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-textPrimary">Pro Creator</p>
              <p className="text-xs text-textSecondary mt-2">Includes Blog Generation, Social Clips, and Priority Support.</p>
            </div>
            <button
              onClick={() => navigate('/usage')}
